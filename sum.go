...
// SumBool returns the sum of the values of a bool Slice or an error in case of a nil or empty slice
func SumBool(a []bool) (bool, error) {
	if len(a) == 0 {
...
// SumError returns the sum of the values of a error Slice or an error in case of a nil or empty slice
func SumError(a []error) (error, error) {
	if len(a) == 0 {
		return 0, errors.New("Cannot calculate the sum of a nil or empty slice")
	}
...
// SumString returns the sum of the values of a string Slice or an error in case of a nil or empty slice
func SumString(a []string) (string, error) {
	if len(a) == 0 {
		return 0, errors.New("Cannot calculate the sum of a nil or empty slice")
	}

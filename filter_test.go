...
func TestFilterError(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				a:    nil,
				keep: func(error) bool { panic("not implemented") },
			},
			want: nil,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := FilterError(tt.args.a, tt.args.keep); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("FilterError() = %v, want %v", got, tt.want)
			}
		})
	}
}
